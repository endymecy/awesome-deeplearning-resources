...
- Neural GPUs Learn Algorithms. [[pdf]](docs/2015/Neural GPUs Learn Algorithms.pdf) [[arxiv](https://arxiv.org/abs/1511.08228)] [[tensorflow](https://github.com/tensorflow/models/tree/master/neural_gpu)] :star:
...
- <b>[ResNet]</b> [Deep Residual Learning for Image Recognition](http://blog.csdn.net/cv_family_z/article/details/50328175). [[pdf]](docs/2015/Deep Residual Learning for Image Recognition.pdf) [[arxiv](https://arxiv.org/abs/1512.03385)] [[tensorflow](https://github.com/tensorflow/models/tree/master/resnet)] :star: 
...
- <b>[Faster R-CNN]</b> Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks. [[arxiv](https://arxiv.org/abs/1506.01497)] [[code](https://github.com/rbgirshick/py-faster-rcnn)] :star: 
...
- Rethinking the Inception Architecture for Computer Vision. [[pdf]](docs/2015/Rethinking the Inception Architecture for Computer Vision.pdf) [[arxiv](https://arxiv.org/abs/1512.00567)] [[tensorflow](https://github.com/tensorflow/models/tree/master/inception)] :star: 
...
- <b>[LAS]</b> Listen, Attend and Spell. [[pdf]](docs/2015/Listen, Attend and Spell.pdf) [[arxiv](https://arxiv.org/abs/1508.01211)] :star:
...
- <b>[Soft And Hard Attention]</b> Show, Attend and Tell: Neural Image Caption Generation with Visual Attention. [[arxiv](https://arxiv.org/abs/1502.03044)] [[code](https://github.com/kelvinxu/arctic-captions)] :star:
...
- [Spatial Transformer Networks.](http://blog.csdn.net/shaoxiaohu1/article/details/51809605) [[pdf]](docs/2015/Spatial Transformer Networks.pdf) [[arxiv](https://arxiv.org/abs/1506.02025)] [[tensorflow](https://github.com/tensorflow/models/tree/master/transformer)] :star: 
...
- DeepMPC: Learning Deep Latent Features for Model Predictive Control.  [[url](http://deepmpc.cs.cornell.edu/DeepMPC.pdf)]
- Deterministic Policy Gradient Algorithms.  [[url](http://jmlr.org/proceedings/papers/v32/silver14.pdf)] :star: 
...
- Language Understanding for Text-based Games Using Deep Reinforcement Learning.  [[url](http://people.csail.mit.edu/karthikn/pdfs/mud-play15.pdf)] :star: 
- Learning Continuous Control Policies by Stochastic Value Gradients.  [[url](http://papers.nips.cc/paper/5796-learning-continuous-control-policies-by-stochastic-value-gradients.pdf)] :star: 
...
- Massively Parallel Methods for Deep Reinforcement Learning.  [[url](http://www0.cs.ucl.ac.uk/staff/d.silver/web/Publications_files/gorila.pdf)] :star: 
...
- Trust Region Policy Optimization. [[url](http://jmlr.org/proceedings/papers/v37/schulman15.pdf)] :star: 
- Universal Value Function Approximators. [[url](http://schaul.site44.com/publications/uvfa.pdf)]
